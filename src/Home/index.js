        ...
        <div className="home__container container grid">
          <div className="home__content grid">
            <div className="home__social">
              <a
                href="https://www.linkedin.com/in/khanalsushant/"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://www.upwork.com/freelancers/~01ac369dec101e826b"
                target="_blank"
                rel="noreferrer"
                className="home__social-icon"
              >
              ...
              <a
                href="https://github.com/SushantKhanal"
                target="_blank"
                rel="noreferrer"
                className="home__social-icon"
              >
              ...
              <svg className="home__blob" viewBox="0 0 200 187">
                ...
                <g mask="url(#mask0)">
                  ...
                  <image
                    ...
                    x="12"
                    y="18"
                    href={require("../assets/img/sushantPic.png")}
                  />
                </g>
              </svg>
            </div>
